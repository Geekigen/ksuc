            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							<a href="/course/create" class="active"><i class="fa fa-home nav_icon"></i>Create courses </a>
						</li>
						<li>
							<a href="/course"><i class="fa fa-cogs nav_icon"></i>Manage courses  <span class="fa arrow"></span></a>
			
							<!-- /nav-second-level -->
						</li>
					
						<li>
							<a href="/viewrating"><i class="fa fa-cogs nav_icon"></i>View ratings<span class="fa arrow"></span></a>
