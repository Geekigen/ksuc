        ...
        <div class="container">
            ...
            <div class="banner-text">
                <div class="slider-info">
                    <h3>Rate your <span>courses  </span>this  semester </h3>
                    @auth
       <a href="/gorate" class="banner-button btn mt-md-5 mt-4">Proceed to rating</a>
        @endauth
				</div>
            </div>
        </div>
			...
			<div class="row ban_form">
				<div class="col-lg-8 bg-white fom-left">
					<div class="categories_sub cats1">
						...
						<p class="vam">We value your feedback .Please rate your course </p></div>
				</div>
